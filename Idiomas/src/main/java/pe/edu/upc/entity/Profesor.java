...
public class Profesor extends Master implements Serializable {
	...
	@Size(max=50, message="El nombre del profesor debe tener como máximo 50 caracteres.")
	...
	@Size(max=50, message="El apellido del profesor debe tener como máximo 50 caracteres.")
	...
	@Size(max=50, message="El correo del profesor debe tener como máximo 50 caracteres.")
	@Email(message = "El correo del profesor ingresado no tiene un formato válido.")
	@Column(name="correo", nullable=false, length=50)
	private String correo;

	@NotEmpty(message="Debes ingresar obligatoriamente la contraseña del profesor.")
	@NotBlank(message="La contraseña del profesor no puede estar en blanco.")
	@Size(max=50, message="La contraseña del profesor debe tener como máximo 50 caracteres.")
